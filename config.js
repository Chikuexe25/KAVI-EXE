...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pNwz3LAL#r8Z2kCKwf5vLnjgKhQdI8rVTUT4pQxahvLJvhfsjJaQ",
...
AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "*SEEN YOUR STATUS BY CHIKU-EXE 🤍*",
};
